...
object TreatedProfessionallyQuestion extends Enumerable.Implicits {
  ...
  private case object StronglyAgree extends WithName("StronglyAgree") with TreatedProfessionallyQuestion
  ...
  private case object StronglyDisagree extends WithName("StronglyDisagree") with TreatedProfessionallyQuestion
