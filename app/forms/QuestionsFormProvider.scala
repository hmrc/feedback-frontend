  ...
  def apply(): Form[OtherQuestions] =
    Form(
      mapping(
        ...
        "whyGiveScore"      ->
          optional(
            text("whyGiveScore.error.required")
  ...
  def apply(): Form[NinoQuestions] =
    Form(
      mapping(
        ...
        "didWithNino"       -> optional(
          seq(
            exclusiveSeqElem[DidWithNinoQuestion](invalidKey = "didWithNino.error", exclusiveOptionName = "noneOfAbove")
          )
        ),
        "whyGiveAnswer"     ->
          optional(
  ...
  def apply(): Form[PTAQuestions] =
    Form(
      mapping(
        "neededToDo"        ->
          optional(
            text("neededToDo.error.required")
  ...
  def apply(): Form[BTAQuestions] =
    Form(
      mapping(
        ...
        "mainServiceOther"  ->
          optional(
            text("mainServiceOther.error.required")
  ...
  def apply(): Form[TrustsQuestions] =
    Form(
      mapping(
        ...
        "tryingToDoOther"   ->
          optional(
            text("tryingToDoOther.error.required")
              .verifying(maxLength(maxFieldSizeTryingToDoOther, "generic.max-characters"))
          ),
        "ableToDo"          -> optional(enumerable[AbleToDo](invalidKey = "ableToDo.error")),
        "whyNotAbleToDo"    -> optional(
          text("whyNotAbleToDo.error.required")
  ...
  def apply(): Form[PensionQuestions] =
    Form(
      mapping(
        "ableToDo"          -> optional(enumerable[AbleToDo](invalidKey = "ableToDo.error")),
        "howEasyScore"      -> optional(enumerable[HowEasyQuestion](invalidKey = "howEasyScore.error")),
        "whyGiveScore"      -> optional(
          Forms.text.verifying(maxLength(maxFieldSizeWhyGiveScore, "whyGiveScore.error.maxlength"))
        ),
        "howDoYouFeelScore" -> optional(enumerable[HowDoYouFeelQuestion](invalidKey = "howDoYouFeelScore.error")),
