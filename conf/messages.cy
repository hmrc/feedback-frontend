...
site.service_name = feedback-frontend
site.textarea.char_limit = (Limit is {0} characters)

unauthorised.title = You can’t access this service with this account
unauthorised.heading = You can’t access this service with this account

otherQuestions.title = Give feedback
...
btaServiceQuestion.SelfAssessment = Self assessment
btaServiceQuestion.PAYE = PAYE for employers
btaServiceQuestion.VAT = VAT
btaServiceQuestion.CorporationTax = Corporation tax
btaServiceQuestion.CIS = Construction industry scheme (CIS)
btaServiceQuestion.ECSales = EC sales
btaServiceQuestion.Other = Other

howDoYouFeelQuestion.VerySatisfied = Very satisfied
howDoYouFeelQuestion.Satisfied = Satisfied
howDoYouFeelQuestion.Moderate = Neither satisfied nor dissatisfied
...
btaQuestions.title = Give feedback
